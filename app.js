...
function getAnswers(a11,a12,a13,b1,a21,a22,a23,b2,a31,a32,a33,b3) {
  var clonedSystem = JSON.parse(JSON.stringify(system));
      ...
      document.getElementById('check_1').innerHTML = firstEquation +  '=' + realAnswer1 +'=> sistēma ir saderīga';
      }else{
      document.getElementById('check_1').innerHTML = firstEquation +  '=' + realAnswer1 + '=> sistēma ir nesaderīga';
      }
      if (secondEquation==clonedSystem[1].b2){
      document.getElementById('check_2').innerHTML = secondEquation + '=' + realAnswer2 + '=> sistēma ir saderīga';
      }else{
      document.getElementById('check_2').innerHTML = secondEquation + '=' + realAnswer2 + '=> sistēma ir nesaderīga';
      }
      if (thirdEquation==clonedSystem[2].b3){
      document.getElementById('check_3').innerHTML = thirdEquation + '=' + realAnswer3 + '=> sistēma ir saderīga';
      }else{
      document.getElementById('check_3').innerHTML = thirdEquation + '=' + realAnswer3 + '=> sistēma ir nesaderīga';
      }
...
// 3 vienadojuma sanak nepareiza atbilde ||Radit ciparus lidz 4 cipari aiz komata
